                ...
                for iodepth in iodepth_args:
                    for rw in rw_args:
                        ...
                        if stat != 0:
                            ...
                            # write to file
                            title = '\n\n====================  bs=' + bs + ', iodepth=' + iodepth + ', rw=' + rw + '  ====================\n'
                            write_to_file(file_path, title)
                            write_to_file(file_path, out)
                            print out
                            results[bs + '_' + iodepth + '_' + rw] = out
    else:
...
def _results():
    ...
    os.mknod(file_path)
    results_dict = test_fio(file_path)
    output_info = {}
